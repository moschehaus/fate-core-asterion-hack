...
\begin{itemize}
	...
	\item \textbf{Vlastnosti:}
		\begin{itemize}
			\item Hodnocení zbraně +1. 
			\item \trk{Omráčení}: V případě úspěchu se stylem na akci \akc{Útok} lze případné \asp{Posílení} využít na omráčení nepřítele. Ten musí přehodit svojí \dov{Kondicí} míru úspěchu útočníka; pokud selže, je omráčen na 3 kola.
		\end{itemize}
\end{itemize}
\end{predmet}
...
\begin{itemize}
	...
	\item \textbf{Vlastnosti:}
		\begin{itemize}
			\item Hodnocení zbraně: +2.
			\item Snadno se opravuje, je levná.
		\end{itemize}
\end{itemize}
\end{predmet}
...
\begin{itemize}
	...
	\item \textbf{Vlastnosti:} 
		\begin{itemize}
			\item Hodnocení zbraně: +2. 
			\item Hodí se pro boj proti protivníkům s těžšími zbrojemi: palcát má hodnocení zbraně +3, jestliže má protivník zbroj s hodnocením alespoň +2.
		\end{itemize}
\end{itemize}
\end{predmet}
...
\begin{itemize}
		...
		\item \textbf{Vlastnosti:}
			\begin{itemize}
				\item Hodnocení zbraně: +2. 
				\item Hodí se pro boj proti protivníkům s lehkou či žádnou zbrojí: meč má hodnocení zbraně +3, jestliže má více než 3/4 své výdrže a protivník má zbroj s hodnocením nanejvýš +1. \sidenotemark 
			\end{itemize}
	\end{itemize}
	\end{predmet}
...
\sidenotetext{Situace beze zbroje odpovídá hodnocení zbroje +0}
	...
	\begin{itemize}
		...
		\item \textbf{Vlastnosti:} 
			\begin{itemize}
				\item Hodnocení zbraně: +3. 
				\item Hodí se pro boj proti protivníkům s těžšími zbrojemi: palcát má hodnocení zbraně +4, jestliže má protivník zbroj s hodnocením alespoň +2.
			\end{itemize}
	\end{itemize}
	\end{predmet}
	...
	\begin{itemize}
		...
		\item \textbf{Vlastnosti:}
			\begin{itemize}
				\item Hodnocení zbraně: +3 
				\item Hodí se pro boj proti protivníkům s lehkou či žádnou zbrojí: meč má hodnocení zbraně +4, jestliže má více než 3/4 své výdrže a protivník má zbroj s hodnocením nanejvýš +1. \sidenotemark
			\end{itemize}
	\end{itemize}
	\end{predmet}
\sidenotetext{Je-li třeba, lze rozlišovat kordy, rapíry, flerety, tesáky, dlouhé a krátké meče, šavle, široké meče apod.}
...
\begin{itemize}
	...
	\item \textbf{Vlastnosti:}
		\begin{itemize}
			\item Hodnocení zbraně: +3
			\item \trk{Dlouhá špičatá věc:} Při \akc{Vytváření výhody} s kopím v úzkých prostorech představující \asp{Držím si ho od těla} a podobné získává útočník bonus +2.
		\end{itemize} 
\end{itemize}
\end{predmet}
...
V našich pravidlech rozlišujeme hlavní dvě rodiny střelných zbraní: jednodušší a rychlejší \emph{luky} a složitější a mocnější \emph{kuše.}

\begin{itemize}
	\item s luky lze střílet každé kolo, hodí se proti všem typům zbrojí
	\item s jednoduchými kušemi lze \emph{též střílet každé kolo,} hodí se zejména proti silněji obrněným nepřátelům,
	\item  \emph{kladkové kuše} je třeba jedno kolo nabíjet, tedy vystřelit z nich lze \emph{jednou za dvě kola}; vyznačují se ale vyšším hodnocením zbraně a ještě větší účinností proti pancéřovaným nepřátelům.
\end{itemize}

\begin{predmet}[Krátký luk]
\begin{itemize}
	\item \textbf{Popis:} 
	\item \textbf{Výdrž:} \emph{dle střeliva}
	\item \textbf{Vlastnosti:}
	\begin{itemize}
		\item míření probíhá v nulovém kole
		\item Hodnocení zbraně: +2 
	\end{itemize}
\end{itemize}
\end{predmet}

\begin{predmet}[Dlouhý luk]
\begin{itemize}
	\item \textbf{Popis:} 
	\item \textbf{Výdrž:} \emph{dle střeliva}
	\item \textbf{Vlastnosti:}
...
\begin{predmet}[Lehká jednoduchá kuše]
\begin{itemize}
	\item \textbf{Popis:} 
	\item \textbf{Výdrž:} \emph{dle střeliva}
	\item \textbf{Vlastnosti:}
		\begin{itemize}
			\item míření probíhá v nulovém kole
			\item Hodnocení zbraně: +2
			\item Hodí se proti bojovníkům s těžšími zbrojemi: těžká jednoduchá kuše má hodnocení zbraně +3, pokud má protivník zbroj s hodnocením alespoň +2
		\end{itemize}
\end{itemize}
\end{predmet}

\begin{predmet}[Těžká jednoduchá kuše]
\begin{itemize}
	\item \textbf{Popis:} 
	\item \textbf{Výdrž:} \emph{dle střeliva}
	\item \textbf{Vlastnosti:}
		\begin{itemize}
			\item míření probíhá v nulovém kole
			\item Hodnocení zbraně: +3
			\item Hodí se proti bojovníkům s těžšími zbrojemi: těžká jednoduchá kuše má hodnocení zbraně +4, pokud má protivník zbroj s hodnocením alespoň +2
		\end{itemize}
\end{itemize}
\end{predmet}

\begin{predmet}[Lehká kladková kuše]
\begin{itemize}
	\item \textbf{Popis:} 
	\item \textbf{Výdrž:} 
	\item \textbf{Vlastnosti:} 
		\begin{itemize}
			\item míření trvá jedno kolo
			\item Hodnocení zbraně: +3
			\item Hodí se proti bojovníkům s těžšími zbrojemi: těžká jednoduchá kuše má hodnocení zbraně +4, pokud má protivník zbroj s hodnocením alespoň +2
		\end{itemize}
\end{itemize}
...
\begin{predmet}[Těžká kladková kuše]
\begin{itemize}
	\item \textbf{Popis:} 
	\item \textbf{Výdrž:} 
	\item \textbf{Vlastnosti:} 
		\begin{itemize}
			\item míření trvá jedno kolo
			\item Hodnocení zbraně: +4
			\item Hodí se proti bojovníkům s těžšími zbrojemi: těžká jednoduchá kuše má hodnocení zbraně +5, pokud má protivník zbroj s hodnocením alespoň +2
		\end{itemize}
\end{itemize}
\end{predmet}
