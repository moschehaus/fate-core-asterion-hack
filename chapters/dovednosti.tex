...
\begin{akce}
  \iconitem{prekonani-ikona}{\akc{Překonání:}\dov{Boj beze zbraně} se mimo fyzický konflikt prakticky nevyužívá, tedy jeho využítí pro akci \akc{Překonání} je minimální.\footnote{Hody na \akc{Překonání} jsou totiž nejčastější ve střetech, viz sekce \ref{chap:jdesenavec}.} Jedná-li se například o sportovní boj, či turnaj, v němž postavy chtějí na někoho zapůsobit (resp. musí překonat jeho neochotu), lze \dov{Boj beze zbraně} v těchto speciálních sitaucích použít.}
...
Stejně jako u \dov{Boje beze zbraně} se lze o použítí této dovednosti více dozvědět v sekci \ref{chap:jdesenavec}.\\

\begin{akce}
  \iconitem{prekonani-ikona}{\akc{Překonání:}Podobně jako \dov{Boj beze zbraně}, ani \dov{Boj se zbraní} se mimo fyzický konflikt prakticky nevyužívá, tedy jeho využítí pro akci \akc{Překonání} je minimální.\footnote{Hody na \akc{Překonání} jsou totiž nejčastější ve střetech, viz sekce \ref{chap:jdesenavec}.} Jedná-li se například o sportovní boj, či turnaj, v němž postavy chtějí na někoho zapůsobit (resp. musí překonat jeho neochotu), lze \dov{Boj beze zbraně} v těchto speciálních sitaucích použít.}
